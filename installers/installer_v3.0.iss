...
Source: "..\settings\{#SettingsExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\settings\{#SettingsSourceName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\ico\{#AppIcoName}"; DestDir: "{app}"; Flags: ignoreversion
...
Root: HKCR; Subkey: "Directory\shell\RetroFF\shell\1h264\command"; ValueType: string; ValueData: "cmd /c start /wait /b retroFF -folder %1 -preset h264"
Root: HKCR; Subkey: "Directory\shell\RetroFF\shell\2low"; ValueType: string; ValueData: "To h.264 Low"
Root: HKCR; Subkey: "Directory\shell\RetroFF\shell\2low\command"; ValueType: string; ValueData: "cmd /c start /wait /b retroFF -folder %1 -preset h264_low"
Root: HKCR; Subkey: "Directory\shell\RetroFF\shell\3dnxhd"; ValueType: string; ValueData: "To DNxHD"
Root: HKCR; Subkey: "Directory\shell\RetroFF\shell\3dnxhd\command"; ValueType: string; ValueData: "cmd /c start /wait /b retroFF -folder %1 -preset dnxhd"
Root: HKCR; Subkey: "Directory\shell\RetroFF\shell\4xdcam"; ValueType: string; ValueData: "To XDCAM"
Root: HKCR; Subkey: "Directory\shell\RetroFF\shell\4xdcam\command"; ValueType: string; ValueData: "cmd /c start /wait /b retroFF -folder %1 -preset xdcam"
Root: HKCR; Subkey: "Directory\shell\RetroFF\shell\5custom"; ValueType: string; ValueData: "To Custom Preset"
Root: HKCR; Subkey: "Directory\shell\RetroFF\shell\5custom\command"; ValueType: string; ValueData: "cmd /c start /wait /b retroFF -folder %1 -preset custom"
...
Root: HKCR; Subkey: "Directory\shell\RetroFF\shell\9logs\command"; ValueType: string; ValueData: "cmd /c start /wait /b retroFF -folder %1 -preset h264 -log"
...
Root: HKCR; Subkey: "Directory\shell\RetroFF\shell\runas\command"; ValueType: string; ValueData: "cmd /c start /wait /b retroFF -config"
Root: HKLM; Subkey: "SYSTEM\CurrentControlSet\Control\Session Manager\Environment"; ValueType: expandsz; ValueName: "Path"; ValueData: "{olddata};C:\Program Files\{#MyAppName}"; Check: NeedsAddPath('C:\Program Files\{#MyAppName}')
